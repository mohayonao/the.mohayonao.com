(function(global) {
  ...
  if (typeof(window) !== "undefined") {
    ...
    (function(window) {
      ...
      var StaticMotionMan = (function() {
        ...
        $this.load = function() {
          ...
          if (url) {
            worker = new Worker("../motionman.js");
    ...
    (function(worker) {
      worker.THREE = {};
      importScripts("./ThreeVector3.js");
      importScripts("./ThreeMatrix3.js");
      importScripts("./ThreeMatrix4.js");
      importScripts("./Three.flashlike.js");
      importScripts("./bvh.js");
